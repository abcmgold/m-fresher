...
namespace MISA.WebFresher042023.Demo.Core.Mapper
{
    ...
    public class PropertyTransferProfile : Profile
    {
        ...
        {
            CreateMap<PropertyTransfer, PropertyTransferDto>();
            CreateMap<PropertyTransferCreateDto, PropertyTransfer>();
            CreateMap<PropertyTransferUpdateDto, PropertyTransfer>();
        }
