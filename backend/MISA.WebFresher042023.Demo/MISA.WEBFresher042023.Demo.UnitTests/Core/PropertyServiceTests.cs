...
namespace MISA.WEBFresher042023.Demo.UnitTests.Core
{
    ...
    public class PropertyServiceTests
    {
        ...
        public async Task GetLastTestCodeAsync_Empty_ValidCode()
        {
            ...
            propertyRepository.GetAutoIdAsync().Returns("TS00001");
            ...
            var code = await propertyService.GetAutoIdAsync();

            // Assert
            Assert.That(lastTestCode, Is.EqualTo(code));

            await propertyRepository.Received(1).GetAutoIdAsync();
        }
        ...
        public async Task UpdateAsync_InvalidId_NotFoundException()
        {
            ...
            // Act && Assert
            Assert.ThrowsAsync<NotFoundException>(async () => await propertyService.UpdateAsync(id,propertyUpdateDto));
        }
        ...
        public async Task UpdateAsync_ValidId_NumberRecordUpdated()
        {
            ...
            propertyRepository.UpdateAsync(id, property).Returns(1);
            ...
            // Act
            var res = await propertyService.UpdateAsync(id, propertyUpdateDto);
            // Assert
            Assert.That(res, Is.EqualTo(1));

            await propertyRepository.Received(1).UpdateAsync(id, property);
        }
        ...
        public async Task InsertAsync_DuplicateCode_ExistedPropertyCodeException()
        {
            ...
            propertyRepository.CheckDuplicatePropertyCode("TS00001").Returns(property);
            ...
            // Act && Assert
            Assert.ThrowsAsync<ExistedPropertyCodeException>(async () => await propertyService.InsertAsync(propertyCreateDto));

            await propertyRepository.Received(1).InsertAsync(property);
        }
        ...
        public async Task InsertAsync_ValidCode_NumberRecordInserted()
        {
            ...
            propertyRepository.CheckDuplicatePropertyCode(code).ReturnsNull();

            propertyRepository.InsertAsync(property).Returns(1);
            ...
            // Act
            var res = await propertyService.InsertAsync(propertyCreateDto);
            // Assert
            Assert.That(res, Is.EqualTo(1));
